...
/*******
 * <p>
 * Title: ViewRole2Home Class.
 * </p>
 * 
 * <p>
 * Description: The Java/FX-based Role2 Home Page. The page is a stub for some
...
public class ViewRole2Home {
	...
	/**********
	 * <p>
	 * Method: displayRole2Home(Stage ps, User user)
	 * </p>
	 * 
	 * <p>
	 * Description: This method is the single entry point from outside this package
	 * to cause the Role2 Home page to be displayed.
	 * 
	...
	public static void displayRole2Home(Stage ps, User user) {
		...
		if (theView == null)
			theView = new ViewRole2Home(); // Instantiate singleton if needed
	 ...
	 * changeable fields using the displayRole2Home method.
	 * </p>
	 * 
	 */
	private ViewRole2Home() {
		...
		setupButtonUI(button_ShowDiscussion, "Dialog", 40, 300, Pos.CENTER, 200, 150);
		button_ShowDiscussion.setOnAction((event) -> {ViewDiscussionBoard.display(theStage);});

		// This is the end of the GUI initialization code

		// Place all of the widget items into the Root Pane's list of children
		theRootPane.getChildren().addAll(label_PageTitle, label_UserDetails, button_ShowDiscussion, button_UpdateThisUser, line_Separator1,
