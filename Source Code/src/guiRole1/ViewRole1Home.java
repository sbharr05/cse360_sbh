...
public class ViewRole1Home {
	 ...
	 * to cause the Role1 Home page to be displayed.
	 * 
	...
	private ViewRole1Home() {
		...
		theRootPane.getChildren().addAll(label_PageTitle, label_UserDetails, button_UpdateThisUser, button_ShowDiscussion, line_Separator1,
