 ...
 * to update the attributes about the user held by the system. Currently, this
 * page does not provide a mechanism to change the Username and not all of the
 * functions on this page are implemented.
 * 
 * Currently the following attributes can be updated: - First Name - Middle Name
 * - Last Name - Preferred First Name - Email Address The page uses dialog boxes
 * for updating these items.
 * </p>
 * 
 * <p>
...
public class ViewUserUpdate {
	 ...
	 * to cause the UserUpdate page to be displayed.
	 * 
	 ...
	 * changeable fields using the displayUserUpdate method.
	 * </p>
	 * 
	 */
	...
	private ViewUserUpdate() {
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_Purpose, label_Username, label_CurrentUsername,
				label_Password, label_CurrentPassword, button_UpdatePassword, label_FirstName, label_CurrentFirstName,
				button_UpdateFirstName, label_MiddleName, label_CurrentMiddleName, button_UpdateMiddleName,
				label_LastName, label_CurrentLastName, button_UpdateLastName, label_PreferredFirstName,
				label_CurrentPreferredFirstName, button_UpdatePreferredFirstName, button_UpdateEmailAddress,
				label_EmailAddress, label_CurrentEmailAddress, button_ProceedToUserHomePage);
	}
