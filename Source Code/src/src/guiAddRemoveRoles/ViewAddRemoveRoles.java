...
/*******
 * <p>
 * Title: GUIAddRemoveRolesPage Class.
 * </p>
 * 
 * <p>
 * Description: The Java/FX-based page for changing the assigned roles to users.
 * </p>
 * 
 * <p>
...
public class ViewAddRemoveRoles {
	...
	*/
	...
	// When no user has been selected, only Area 2a is shown. If a user in the
	// ComboBox in Area 1a
	// has been specified, then Area 2b is made visible.

	// Area 2a: This allows the admin to select a user of the system as the first
	// step in adding or
	// removing a role. The act of selecting a user causes the change is the GUI.
	// The Admin does
	...
	// Area 2b: When a user has been selected these widgets are shown and can be
	// used
	...
	*/
	...
	public static void displayAddRemoveRoles(Stage ps, User user) {
		...
		// two
		// modes (1: user has not been selected, and 2: user has been selected) there
		// are two
		// lists of widgets to be displayed. For this reason, we have implemented the
		// following
