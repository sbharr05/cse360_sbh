...
public class ControllerAddRemoveRoles {
	 ...
	 * 
	 * <p>
	 * Description: This method uses the ComboBox widget, fetches which item in the
	 * ComboBox was selected (a user in this case), and establishes that user and
	 * the current user, setting easily accessible values without needing to do a
	 * query.
	 * </p>
	 * 
	 */
	...
	protected static void repaintTheWindow() {
		...
		if (ViewAddRemoveRoles.theSelectedUser.compareTo("<Select a User>") == 0) {
			...
			ViewAddRemoveRoles.theRootPane.getChildren().addAll(ViewAddRemoveRoles.label_PageTitle,
					ViewAddRemoveRoles.label_UserDetails, ViewAddRemoveRoles.button_UpdateThisUser,
					ViewAddRemoveRoles.line_Separator1, ViewAddRemoveRoles.label_SelectUser,
					ViewAddRemoveRoles.combobox_SelectUser, ViewAddRemoveRoles.line_Separator4,
					ViewAddRemoveRoles.button_Return, ViewAddRemoveRoles.button_Logout, ViewAddRemoveRoles.button_Quit);
		} else {
			// Show all the fields as there is a selected user (as opposed to the prompt)
			ViewAddRemoveRoles.theRootPane.getChildren().addAll(ViewAddRemoveRoles.label_PageTitle,
					ViewAddRemoveRoles.label_UserDetails, ViewAddRemoveRoles.button_UpdateThisUser,
					ViewAddRemoveRoles.line_Separator1, ViewAddRemoveRoles.label_SelectUser,
					ViewAddRemoveRoles.combobox_SelectUser, ViewAddRemoveRoles.label_CurrentRoles,
					ViewAddRemoveRoles.label_SelectRoleToBeAdded, ViewAddRemoveRoles.combobox_SelectRoleToAdd,
					ViewAddRemoveRoles.button_AddRole, ViewAddRemoveRoles.label_SelectRoleToBeRemoved,
					ViewAddRemoveRoles.combobox_SelectRoleToRemove, ViewAddRemoveRoles.button_RemoveRole,
	...
	/**********
	 * <p>
	 * Method: setupSelectedUser()
	 * </p>
	 * 
	 * <p>
	 * Description: This method fetches the current values for the widgets whose
	 * values change based on which user has been selected and any actions that the
	 * admin takes.
	 * </p>
	 * 
	 */
	private static void setupSelectedUser() {
		...
		// Create the list of roles that could be added for the currently selected user
		// (e.g., Do
		...
		// Create the list of roles that could be removed for the currently selected
		// user (e.g., Do
		...
		ViewAddRemoveRoles.combobox_SelectRoleToRemove
				.setItems(FXCollections.observableArrayList(ViewAddRemoveRoles.removeList));
	...
	/**********
	 * <p>
	 * Method: performAddRole()
	 * </p>
	 * 
	 * <p>
	 * Description: This method adds a new role to the list of role in the ComboBox
	 * select list.
	 * </p>
	 * 
	 */
	...
	protected static void performAddRole() {
		...
		// If the selection is the list header (e.g., "<Select a role>") don't do
		// anything
