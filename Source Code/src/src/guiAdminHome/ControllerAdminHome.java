...
public class ControllerAdminHome {
	...
	*/
	...
	protected static void setOnetimePassword () {
	    // For TP1 we centralize admin actions in one dialog
	    AdminUsersDialog.display(ViewAdminHome.theStage);
	}
	...
	protected static void deleteUser() {
	    // Not in ADM-01..04; keep stub OR route to admin dialog if you prefer:
	    // AdminUsersDialog.display(ViewAdminHome.theStage);
