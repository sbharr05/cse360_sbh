...
public class ControllerMultipleRoleDispatch {
	 ...
	 * 
	 * <p>
	 * Description: This method directs the execution to one of the various home
	 * pages based on the current value of the SelectRole ComboBox.
	 * </p>
	 * 
	 */
	static protected void performRole() {
		...
		if (role.compareTo("Admin") == 0) {
			...
			// It is Admin Role
			guiAdminHome.ViewAdminHome.displayAdminHome(guiMultipleRoleDispatch.ViewMultipleRoleDispatch.theStage,
			...
			// It is Role1 Role
			guiRole1.ViewRole1Home.displayRole1Home(guiMultipleRoleDispatch.ViewMultipleRoleDispatch.theStage,
					guiMultipleRoleDispatch.ViewMultipleRoleDispatch.theUser);
			...
			// It is Role 2 Role
			guiRole2.ViewRole2Home.displayRole2Home(guiMultipleRoleDispatch.ViewMultipleRoleDispatch.theStage,
					guiMultipleRoleDispatch.ViewMultipleRoleDispatch.theUser);

		} else {
			// Invalid role
			System.out.println("*** ERROR *** GUIMultipleRoleDispatch was asked to dispatch to " + "a role, " + role
	...
	static protected void performLogout() {
		guiUserLogin.ViewUserLogin.displayUserLogin(guiMultipleRoleDispatch.ViewMultipleRoleDispatch.theStage);
	}
