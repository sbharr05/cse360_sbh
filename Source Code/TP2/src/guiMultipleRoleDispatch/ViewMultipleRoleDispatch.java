...
/*******
 * <p>
 * Title: GUIMultipleRoleDispatchPage Class.
 * </p>
 * 
 * <p>
 * Description: The Java/FX-based Admin Update Page.
 * </p>
 * 
 * <p>
...
public class ViewMultipleRoleDispatch {
	...
	// GUI Area 1: It informs the user about the purpose of this page and whose
	// account is being
	...
	// GUI Area 2: This area consists of a label to ask the user what roles to
	// place, a ComboBox
	...
	/**********
	 * <p>
	 * Method: ViewMultipleRoleDispatch()
	 * </p>
	 * 
	 * <p>
	...
	private ViewMultipleRoleDispatch() {
		...
		theRootPane.getChildren().addAll(label_PageTitle, label_UserDetails, line_Separator1, label_WhichRole,
				combobox_SelectRole, button_PerformRole, line_Separator4, button_Logout, button_Quit);
	}
